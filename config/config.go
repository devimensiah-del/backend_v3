...
func (c *Config) Validate() error {
	...
	// Note: PreSearch models are hardcoded in enrichment package, not configured here
	if c.PrimaryModel == "" {
...
func (c *Config) loadFrameworkConfigs() map[string]FrameworkConfig {
	...
	log.Info().
		...
		Msg("Loading analysis AI configuration (enrichment models hardcoded in package)")
