-- Migration: v2_024_split_companies_table.sql
-- Description: Split companies table into step-specific tables for cleaner enrichment
-- Date: 2024-12-21
--
-- SAFETY: This migration is designed to be non-breaking:
-- 1. Creates new tables without touching the original
-- 2. Copies all existing data to new tables
-- 3. Creates a backwards-compatible view
-- 4. Original table is renamed (not dropped) for rollback safety
--
-- ROLLBACK: See v2_024_ROLLBACK_split_companies.sql
...
INSERT INTO company_legacy_data (
    ...
    sector_description, sector_growth_rate, sector_trends,
    key_industry_trends, macro_context, competitive_landscape,
    data_confidence, data_gaps, enriched_at, enrichment_source
)
SELECT
...
-- Point existing FKs to company_core instead of companies
-- =============================================================================
